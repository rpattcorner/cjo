...
ServerName  green.andredsweald.org 
...
<VirtualHost *>
	...
	ProxyPass / http://www.andredsweald.org:8080/
	ProxyPassReverse / http://www.andredsweald.org:8080/
	<Location />
    		Order allow,deny
    		Allow from all
	</Location>
	...
	ServerAlias andredsweald.org *.andredsweald.org
	DocumentRoot /opt/content/andredsweald
	<Directory />
		Options FollowSymLinks
		AllowOverride None
